...
<head>
    ...
    <title>WeUI</title>
    <link rel="stylesheet" href="${u.ctx}/css/weui.less"/>
    <link rel="stylesheet" href="${u.ctx}/css/example.less"/>
    <script src="${u.ctx}/js/zepto.min.js"></script>
</head>
<body >
<div class="page">
    <div class="page__hd">
        <h1 class="page__title">
            <img src="${u.ctx}/images/logo.png" alt="WeUI" height="21px" />
        </h1>
        ...
        <ul>
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="${u.ctx}/images/icon_nav_form.png" alt="">
                </div>
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="${u.ctx}/images/icon_nav_layout.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="${u.ctx}/images/icon_nav_feedback.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="${u.ctx}/images/icon_nav_nav.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_category">
                    ...
                    <img src="${u.ctx}/images/icon_nav_search.png" alt="">
                </div>
                <div class="page__category js_categoryInner">
                    <div class="weui-cells page__category-content">
            ...
            <li>
                <div class="weui-flex js_item" data-id="layers">
                    ...
                    <img src="${u.ctx}/images/icon_nav_z-index.png" alt="">
                </div>
            </li>
        </ul>
    </div>
    <div class="page__ft">
        <a href="javascript:home()"><img src="${u.ctx}/images/icon_footer.png" /></a>
    </div>
</div>
</body>
</html>